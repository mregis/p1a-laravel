...
jQuery(document).ready(function () {
    ...
    //Define globasl masks
    $("#cnpj").add(".cnpj").mask("00.000.000/0000-00",{reverse:true});
    $("#cpf").add(".cpf").mask("000.000.000-00", {reverse:true});
    $("#rg").add(".rg").mask("00.000.000-0");
    $(".date").mask("00/00/0000");
    $("#tel").add(".tel").mask("(00) 999999999");
    $("#phone").add("#fax").mask("(00) 00000000");
