                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg m-input" name="agency" id="agency"
                                               data-mask="0000" required="required"
                                               data-validation="notempty($(this))" data-label="{{__('labels.type')}}"
                                               data-error="{{__('labels.field_not_empty')}}" placeholder="Agência"
                                               value="">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="mod">Tipo de Documento</label>
                                        <select class="form-control form-control-lg m-input m-input--square"
                                                name="type" id="type"
                                                required="required"
                                            ...
                                            <option value="produto"
                                                    @if(isset($produto) && $produto->mod == 'produto') selected @endif;>
                                                Produto
                                            </option>
                                        </select>
                                    </div>
