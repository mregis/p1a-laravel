                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-3">
                                                    ...
                                                    <input type="text"
                                                           class="form-control form-control-lg m-input{{$errors->has('origem') ? ' is-invalid' : ''}}"
                                                           name="origem" id="origem" data-mask="0000"
                                                           required="required"
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <input type="text"
                                                           class="form-control form-control-lg m-input{{$errors->has('destino') ? ' is-invalid' : ''}}"
                                                           name="destino" id="destino"
                                                           data-mask="0000" required="required"
                                                           data-validation="notempty($(this))"
                                                           data-label="{{__('labels.destino')}}"
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <input type="text"
                                                           class="form-control form-control-lg m-input{{$errors->has('qtdedocs') ? ' is-invalid' : ''}}"
                                                           name="qtdedocs"
                                                           id="qtdedocs" data-mask="00" required="required"
                                                           data-label="{{__('labels.qtdedocs')}}"
                                                           placeholder="Qtde Documentos"
                                                           value="{{old('qtdedocs')}}">
                                                </div>
                                            </div>
                                        </div>
