...
@section('content')
    ...
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="javascript:void(0)" class="m-nav__link">
                <span class="m-nav__link-text">{{__('titles.edit_agencia')}}</span>
            </a>
        </li>
    </ul>
                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">Editar Agência <span class="badge badge-primary">{{ $agencia }}</span> </h3>
                        </div>
                    </div>
                </div>
                <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <a class="btn btn-primary btn-lg" href="{{route('agencias.index')}}">Cancelar</a>
