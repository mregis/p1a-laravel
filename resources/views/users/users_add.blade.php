    ...
    <div class="row">
        <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
                ...
                {{ Form::open(array('url' => url('api/users'), 'class'=>'m-form m-form--fit m-form--label-align-right ajax-form', 'id'=>'form_user', 'name'=>'form_user', 'data-toggle'=>'validator')) }}
                <div class="m-portlet__body">
                    ...
                    <div class="m-form__group row">
                        <div class="form-group col-md-4 inputGroupContainer" id="juncao" style="display:none">
                            <label class="control-label" for="juncao">Junção</label>
                            <input type="text" class="form-control m-input" name="juncao" data-validation="notempty($(this))" >
                        </div>
                        <div class="form-group col-md-4 inputGroupContainer" id="unidade" style="display:none">
                            <label class="control-label" for="unidade">Unidade</label>
                            <input type="text" class="form-control m-input" name="unidade" data-validation="notempty($(this))">
                        </div>
                    </div>
